        ...
        <div className="flex w-[1170px] mr-auto h-[500px] ml-auto mb-[4rem] bg-black" >
                    ...
                    <div className="flex flex-col justify-start bg-red-500 ml-[4rem] items-center align-center">
                        <div className="flex flex-col justify-start space-y-1">
                            ...
                            <span className="text-white font-poppins font-bold ">Enhance Your</span>
                            <span className="text-white font-poppins font-bold">Music Experience</span>
                        </div>
                        <div className="flex justify-start space-x-5">

                            <div className="justify-center align-center items-center  flex flex-col rounded-full bg-white">
                                <span className="text-sm font-bold text-black">23</span>
                                <span className="text-black text-[1rem]">Hours</span>
                            </div>


                            <div className="justify-center align-center items-center  flex flex-col rounded-full bg-white">
                                <span className=" text-sm font-bold text-black text-black">23</span>
                                <span className="text-black">Days</span>
                            </div>


                            <div className="justify-center align-center items-center  flex flex-col rounded-full bg-white">
                                <span className=" text-sm text-center font-bold text-black text-black">23</span>
                                <span className="text-black font-bold text-[8px]">Minutes</span>
                            </div>
